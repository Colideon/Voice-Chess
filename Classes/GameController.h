...
@interface GameController : NSObject <UIActionSheetDelegate, ATTSpeechServiceDelegate> {
   ...
   LastMoveView *lastMoveView;
    ...
    // OpenEars
    NSArray *chessNumbers, *chessLetters, *chessPieces, *chessListens;
    
    // 4 Promote to
    BOOL wantToPromote;
    UIActionSheet * promoteAC;
    SystemSoundID vcBeepSound;
}
